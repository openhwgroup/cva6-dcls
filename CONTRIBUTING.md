...
As the name of the repository suggest, the heart of DCLS-CVA6 is the CVA6 itself.
The CVA6 has turned into an industrial project, where the core is being verified to be integrated in production ICs.
